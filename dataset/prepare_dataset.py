...
from normalizers import Sentinel2Normalizer, get_sentinel2_statistics
...
def parse_args():
    ...
    parser.add_argument('--validity_mask_path', type=str, default=None,
    ...
    parser.add_argument('--normalize_method', type=str, default='pretrained',
...
def main():
    ...
    train_transform = get_train_transform(p=0.5, patch_size=args.patch_size)
    ...
    # Normalize RGB channels for display
    ...
    print(f"Sample visualization saved to {os.path.join(args.output_dir, 'samples', 'sample_batch.png')}")
