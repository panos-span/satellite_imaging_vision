...
python run_experiment.py --data_dir F:\processed_data\training_dataset_256 --encoder_type resnet18 --use_normalizer --batch_size 8 --num_epochs 20 --early_stopping 5 --save_dir F:\processed_data\model_experiments_special --wandb_project sentinel2_landcover --patch_size 256 --use_copy_paste --custom_experiment --experiment_config experiments_config.json --use_improved_sampler --use_copy_paste
"""
