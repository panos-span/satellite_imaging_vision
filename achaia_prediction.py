...
Usage:
    python achaia_prediction.py --model_path "F:\\processed_data\experiment_results\experiments\cosine_annealing\unet_sentinel2_best.pth" --input_path pred.zip --reference_path GBDA24_ex2_34SEH_ref_data.tif --output_dir "F:\\prediction"
"""
